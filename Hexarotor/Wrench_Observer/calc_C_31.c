 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue Jan 22 20:03:07 2019
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME calc_C_31
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
#define SOURCEFILES           "__SFB__C_num_simp_31.c__SFB__C_num_simp_31_initialize.c__SFB__C_num_simp_31_terminate.c__SFB__"
#define PANELINDEX            8
...
extern void calc_C_31_Outputs_wrapper(const real_T *phi,
			const real_T *the,
			const real_T *psi,
			const real_T *theta1,
			const real_T *theta2,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    real_T *C_31 = (real_T *) ssGetOutputPortRealSignal(S, 0);

    calc_C_31_Outputs_wrapper(phi, the, psi, theta1, theta2, theta3, C_31);
