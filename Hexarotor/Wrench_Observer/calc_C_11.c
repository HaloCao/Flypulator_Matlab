 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue Jan 22 19:50:05 2019
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME calc_C_11
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
#define SOURCEFILES           "__SFB__C_num_simp_11.c__SFB__C_num_simp_11_initialize.c__SFB__C_num_simp_11_terminate.c"
#define PANELINDEX            8
...
extern void calc_C_11_Outputs_wrapper(const real_T *phi,
			const real_T *the,
			const real_T *psi,
			const real_T *theta1,
			const real_T *theta2,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    real_T *C_11 = (real_T *) ssGetOutputPortRealSignal(S, 0);

    calc_C_11_Outputs_wrapper(phi, the, psi, theta1, theta2, theta3, C_11);
