/*
 * File: Inertia_Matrix_simplified.c
 *
  *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Sat Jan 19 15:52:08 2019
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME Inertia_Matrix_simplified
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
#define SOURCEFILES "__SFB__Inertia_Matrix.c__SFB__Inertia_Matrix_initialize.c__SFB__Inertia_Matrix_terminate.c__SFB__rt_nonfinite.c__SFB__rtGetInf.c__SFB__rtGetNaN.c"
#define PANELINDEX           6
...
extern void Inertia_Matrix_simplified_Outputs_wrapper(const real_T *phi,
			const real_T *the,
			const real_T *psi,
			const real_T *theta1,
			const real_T *theta2,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real_T   *the  = (const real_T*) ssGetInputPortSignal(S,1);
    const real_T   *psi  = (const real_T*) ssGetInputPortSignal(S,2);
    const real_T   *theta1  = (const real_T*) ssGetInputPortSignal(S,3);
    const real_T   *theta2  = (const real_T*) ssGetInputPortSignal(S,4);
    const real_T   *theta3  = (const real_T*) ssGetInputPortSignal(S,5);
    real_T        *M  = (real_T *)ssGetOutputPortRealSignal(S,0);

    Inertia_Matrix_simplified_Outputs_wrapper(phi, the, psi, theta1, theta2, theta3, M);
