/*
 * File: Inertia_Matrix_accelerator.c
 *
 *
 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Thu Jan 24 09:02:23 2019
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME Inertia_Matrix_accelerator
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void Inertia_Matrix_accelerator_Outputs_wrapper(const real_T *phi,
			const real_T *the,
			const real_T *psi,
			const real_T *theta1,
			const real_T *theta2,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    Inertia_Matrix_accelerator_Outputs_wrapper(phi, the, psi, theta1, theta2, theta3, M);
