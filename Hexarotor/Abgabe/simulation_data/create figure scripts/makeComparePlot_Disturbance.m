...
plot(t,pid_plot./max(pid_plot),'linewidth',factor*2,'Color',[0    0    0])
hold on;
plot(t,ib_plot./max(ib_plot),'linewidth',factor*2,'Color',[0.9290    0.6940    0.1250])
plot(t,ism_plot./max(ism_plot),'linewidth',factor*2,'Color',[0.4940    0.1840    0.5560])
...
%print('../../Thesis/figures/IdealCase_comp_x_dist.eps','-depsc2')
...
plot(t,pid_plot2./max(pid_plot2),'linewidth',factor*2,'Color',[0    0    0])
hold on;
plot(t,ib_plot2./max(ib_plot2),'linewidth',factor*2,'Color',[0.9290    0.6940    0.1250])
plot(t,ism_plot2./max(ism_plot2),'linewidth',factor*2,'Color',[0.4940    0.1840    0.5560])
legend({'PID','IB','ISM'},'Location','NorthEast','Interpreter','latex');
xlabel('$t$ [s]');
...
%print('../../Thesis/figures/IdealCase_comp_roll_dist.eps','-depsc2')
